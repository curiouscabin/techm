...
$(document).ready(function () {
    ...
    var typed = new Typed(".typing",{
        strings: ["Web designer","Web developer","Full stack developer","Social media manager"],
        typeSpeed: 100,
        backSpeed: 60,
        loop: true,
        fadeOut: true,
    ...
    var typed = new Typed(".typing-2",{
        strings: ["Dynamic websites","Communication solutions","Host and manage your content in cloud","Web marketing"],
        typeSpeed: 100,
        backSpeed: 60,
        loop: true,
    });
